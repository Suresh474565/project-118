...
rdn_num = Math.floor((Math.random()*quick_draw_data_set.length)+1);

console.log( quick_draw_data_set[rdn_num]);

sketch = quick_draw_data_set[rdn_num];

document.getElementById("sketch_name").innerHTML="THE SKETCH TO BE DRAWN IS -" + sketch;
...
document.getElementById("timer").innerHTML= "Time ="+ time_counter;
